public class Task {
    ...
    1.Poczytać co to jest złożoność obliczeniowa (do czego to służy, jakie są jej rodzaje, jak można to policzyć).
2.Napisz program generujący jednowymiarową tablicę losowych liczb (10 elementów) w której każda liczba jest podzielna przez 7. Wynikiem działania programu ma być wyświetlona tablica. Zakres losowych liczb 0 - 100.
...
5.Napisz program w którym jest zmienna 'w'. Zmienna ta oznacza wysokość choinki. Program wyświetla na ekranie wypisaną choinkę o danej wysokości. Przykłady:
 ...
 *******
*********
6.Napisz program który generuje jednowymiarową tablicę (10 elementów) losowych liczb. Wynikiem działania programu ma być wygenerowana tablica oraz ilość powtórzeń liczby 5. Zakres losowych liczb 0 - 10.
7.Napisz program który generuje jednowymiarową tablicę (10 elementów) losowych liczb. Program ma wygenerować druga tablicę która jest pierwszą tablicą w odwrotnej kolejności. Wynikiem działania programu ma być wyświetlona pierwsza i druga tablica. Przykłady:
3, 23, 2, 23, 53
...
9.Napisz program który losuje dwie tablice (10 elementów, zakres 0 - 100). Wynikiem działania programu mają być wypisane obie tablice, oraz trzecia tablica w które każdy element jest sumą odpowiadających elementów z dwóch pierwszych tablic. Przykład:
1 4 4 64 45
23 32 5 23 3
24 36 9 87 48
...
13.Napisz program który symuluje rzuty dwiema kastkami do gry (takie zwykłe białe kości jak w monopoly). Program ma wykonać 10 000 rzutów i wypisać liczbę która wypadała najczęściej (ta liczba jest oczywiście sumą oczek na dwóch kościach które symulujemy.
14.Napisz program który generuje tablicę liczb 0 i 1 (10 elementów). Program ma sprawdzić czy tablica jest symetryczna - pierwszy element taki jak ostatni, drugi taki jak przedostatni itd. Wynikiem działania programu ma być wypisana wygenerowana tablica oraz true albo false w zależności czy jest symetria czy nie. (edited)
   ReactReply
